...
type CSSAnimMap = Record<string, number | string>;
...
// (removed unused AnimationConfig type)
      ...
      >
        ...
        >
          ...
          <div className="grid grid-cols-1 rounded-lg sm:rounded-xl md:rounded-4xl p-1 sm:p-1.5 md:p-2 shadow-md shadow-black/5">
            <div className="rounded-md sm:rounded-lg md:rounded-3xl bg-card text-card-foreground p-2 sm:p-3 md:p-4 shadow-xl ring-1 ring-border">
